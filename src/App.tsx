...
const PUBLIC_PROFILE_URL = 'https://coachdv.netlify.app/';
          ...
          <div className="relative z-10 px-8 py-16 md:py-24 lg:px-16 flex flex-col md:flex-row-reverse gap-12 items-center">
            ...
            <div className="flex-1 space-y-8 text-center md:text-left">
              <motion.div 
                ...
                transition={{ duration: 0.8, ease: "easeOut" }}
              >
                <h1 className="text-4xl md:text-6xl font-display font-bold tracking-tight mb-2 text-white">
                  Dmitry Fedoseev
                </h1>
                <h2 className="text-2xl md:text-3xl text-maize-400 font-semibold mb-4">
                  High-Performance Basketball Leader
                </h2>
                <p className="text-lg md:text-xl text-gray-300 font-medium max-w-2xl leading-snug mx-auto md:mx-0">
                  NCAA Division I | Player Development | Scouting | Analytics
                </p>
              </motion.div>
          ...
          <div className="lg:col-span-2 space-y-16 print:space-y-10">
            ...
            <section>
              ...
              <div className="space-y-10 print:space-y-6">
                ...
                <FadeIn delay={0.1} className="relative pl-8 before:absolute before:left-0 before:top-2 before:bottom-0 before:w-0.5 before:bg-gray-200 print:pl-4 print:before:hidden">
                  ...
                  <p className="text-navy-800 font-medium mb-4 print:mb-2 print:text-sm">Graduate Assistant – Men’s Basketball <span className="text-gray-500 font-normal">| Ann Arbor, MI</span></p>
            ...
            <section className="page-break-inside-avoid">
              ...
              <FadeIn delay={0.1} className="relative pl-8 before:absolute before:left-0 before:top-2 before:bottom-0 before:w-0.5 before:bg-gray-200 print:pl-4 print:before:hidden">
                <div className="absolute left-[-5px] top-2 w-3 h-3 rounded-full bg-gray-300 border-2 border-white print:hidden"></div>
                <div className="mb-2 flex flex-col sm:flex-row sm:justify-between sm:items-baseline">
                  <h3 className="text-xl font-bold text-gray-900 print:text-lg">BC Peresvet-SFU / Rostov-Don-SFU (Russia)</h3>
              ...
              <FadeIn delay={0.2} className="relative pl-8 before:absolute before:left-0 before:top-2 before:bottom-0 before:w-0.5 before:bg-gray-200 print:pl-4 print:before:hidden mt-10 print:mt-6 page-break-inside-avoid">
                <div className="absolute left-[-5px] top-2 w-3 h-3 rounded-full bg-gray-300 border-2 border-white print:hidden"></div>
                <div className="mb-2 flex flex-col sm:flex-row sm:justify-between sm:items-baseline">
                  <h3 className="text-xl font-bold text-gray-900 print:text-lg">Dynamo Moscow (Russia)</h3>
            ...
            <section className="page-break-inside-avoid mt-16 print:mt-10">
              <FadeIn>
                <div className="flex items-center gap-3 mb-8 print:mb-4">
                  <div className="p-3 bg-navy-900 text-maize-500 rounded-xl print:p-0 print:bg-transparent print:text-navy-900">
                    <Activity size={24} />
                  </div>
                  <h2 className="text-3xl font-display font-bold text-navy-900 print:text-xl print:uppercase print:tracking-wider print:border-b print:border-gray-300 print:pb-1 print:w-full">Research & Publications</h2>
                </div>
              </FadeIn>

              <FadeIn delay={0.1}>
                <p className="text-navy-800 font-medium mb-4 print:mb-2 print:text-sm">
                  Author of 30+ scientific publications in basketball performance, scouting, and training methodology.
                </p>
                <h4 className="text-lg font-bold text-gray-900 mb-3 print:text-base">Selected publications:</h4>
                <ul className="space-y-3 text-gray-600 print:text-sm print:space-y-1">
                  <li className="flex items-start gap-2">
                    <ChevronRight size={18} className="text-maize-500 shrink-0 mt-0.5 print:hidden" />
                    <span className="print:list-item print:ml-4">Digital Scouting Technologies in Game Sports (2021)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <ChevronRight size={18} className="text-maize-500 shrink-0 mt-0.5 print:hidden" />
                    <span className="print:list-item print:ml-4">Adaptation of the training process of highly qualified women’s basketball teams (2021)</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <ChevronRight size={18} className="text-maize-500 shrink-0 mt-0.5 print:hidden" />
                    <span className="print:list-item print:ml-4">Competitive intensity and performance analysis in professional basketball</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <ChevronRight size={18} className="text-maize-500 shrink-0 mt-0.5 print:hidden" />
                    <span className="print:list-item print:ml-4">Modern trends in scouting in team sports</span>
                  </li>
                </ul>
              </FadeIn>
            </section>
          ...
          <div className="col-span-8 space-y-3">
            <section>
              ...
              <div className="space-y-2">
                ...
                <div>
                  ...
                  <p className="text-[9pt] font-semibold text-navy-800 italic mb-0.5">Graduate Assistant – Men’s Basketball | Ann Arbor, MI</p>
            ...
            <section className="mt-3">
              ...
              <ul className="list-disc ml-4 text-[9pt] leading-tight text-gray-800 space-y-0">
                ...
                <li>Modern trends in scouting in team sports</li>
              </ul>
            </section>
          </div>
          ...
          <div className="col-span-4 space-y-3">
            <section>
              ...
              <ul className="space-y-1.5 text-[9pt] leading-tight text-gray-800">
                ...
                <li><span className="font-bold">ICAB Program</span><br/>FIBA / USOPC / IOC</li>
                <li><span className="font-bold">FIBA Europe Coaching Certificate (FECC)</span><br/>2011–2013</li>
            ...
            <section>
              ...
              <div className="flex flex-wrap gap-x-1 gap-y-0.5 text-[8pt] text-gray-800">
                ...
                <span className="bg-gray-100 px-1.5 py-0.5 rounded border border-gray-200">Training Programming</span>
                <span className="bg-gray-100 px-1.5 py-0.5 rounded border border-gray-200">Synergy Sports</span>
                <span className="bg-gray-100 px-1.5 py-0.5 rounded border border-gray-200">Hudl</span>
            ...
            <section className="pt-3 mt-3 border-t border-gray-300 text-center">
              ...
              <p className="text-[8pt] font-bold text-navy-900 uppercase tracking-wide leading-tight">Scan to view full<br/>online profile</p>
              <p className="text-[8pt] font-medium text-gray-600 mt-0.5">coachdv.netlify.app</p>
            </section>
          </div>
        </div>
      </div>
